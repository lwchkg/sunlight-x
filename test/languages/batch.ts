...
describe("Batch file (DOS) tests", function () {
  describe("file #1", function () {
    ...
    it("REM comment", function () {
      testSupport.AssertContentExists("comment", "REM http://en.wikipedia.org/wiki/Batch_file#Advanced_batch_example_-_conditional_shutdown");
    });
    it(":: comment", function () {
      testSupport.AssertContentExists("comment", ":: http://en.wikipedia.org/wiki/Batch_file#Text_output_with_stripped_CR.2FLF");
    });
  });
