...
describe("Perl tests", function () {
  ...
  it("subroutine name after \\&", function () {
    testSupport.AssertContentExists("named-ident", "referenceOrSomethingIGuess");
  });
  ...
  it("raw q string with nested () delimiters", function () {
    testSupport.AssertContentExists("rawString", "q(I don't know what to do (with) $foo)");
  });
  ...
  it("pod", function () {
    testSupport.AssertContentExists("docComment", "=pod\n=head1 Heading Text\n=cut this should not be parsed");
  });
  ...
  it("regex literal prepended by s delimited by { and [ with modifiers", function () {
    testSupport.AssertContentExists("regexLiteral", "s {\n\t/\\* # Match the opening delimiter.\n\t.*? # Match a minimal number of characters.\n\t\\*/ # Match the closing delimiter.\n} []gsx");
  });
  ...
  it("regex literal prepended by tr delimited by [ with whitespace", function () {
    testSupport.AssertContentExists("regexLiteral", "tr [\\200-\\377]\n\t[\\000-\\177]");
  });
