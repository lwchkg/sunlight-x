...
describe("MySQL tests", function() {
  beforeAll(function() {
    testSupport = new TestSupportForFile("mysql.sql", "mysql");
  });
  it("-- comment", function() {
    testSupport.AssertContentExists("comment", "--comment 1");
  });
  it("# comment", function() {
    testSupport.AssertContentExists("comment", "#comment 2");
  });
  ...
  it("START TRANSACTION keyword", function() {
    testSupport.AssertContentExists("keyword", "START TRANSACTION");
  });
  it("COMMIT keyword", function() {
    testSupport.AssertContentExists("keyword", "COMMIT");
  });

  it("LEFT function", function() {
    testSupport.AssertContentExists("function", "LEFT");
  });
  it("LENGTH function", function() {
    testSupport.AssertContentExists("function", "LENGTH");
  });
