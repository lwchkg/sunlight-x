...
describe("PHP tests", function () {
  ...
  describe("file #1", function () {
    ...
    it("fully qualified class name 1", function () {
      testSupport.AssertContentExists("named-ident", "FullyQualifiedClassName1");
    });
    it("fully qualified class name 2", function () {
      testSupport.AssertContentExists("named-ident", "FullyQualifiedClassName2");
    });
    ...
    it("Perl-style comment", function () {
      testSupport.AssertContentExists("comment", "#Perl-style comments are stupid");
    });
    ...
    it("double quoted string with escaped quote", function () {
      testSupport.AssertContentExists("string", '"this one is my \\"favorite\\""');
    });
    ...
    it("emptyheredoc", function () {
      testSupport.AssertContentExists("nowdoc", "<<<'EMPTYNOWDOC'\nEMPTYNOWDOC");
    });
    it("emptynowdoc", function () {
      testSupport.AssertContentExists("heredoc", "<<<EMPTYHEREDOC\nEMPTYHEREDOC");
    });
    it("nowdoc", function () {
      testSupport.AssertContentExists("nowdoc", "<<<'LULZ'\noh look\na nowdoc!\nLULZ");
    });
    it("heredoc", function () {
      testSupport.AssertContentExists("heredoc", "<<<LOL\noh 'look'\na heredoc!\nLOL");
    });
  });
  describe("file #2", function () {
    ...
    it("unclosed heredoc", function () {
      testSupport.AssertContentExists("heredoc", "<<<HEREDOC\nunclosed heredoc\n");
    });
  });
});