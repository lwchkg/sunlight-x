...
describe("CSharp tests", function () {
  describe("file #1", function () {
    ...
    it("new()'d class", function () {
      testSupport.AssertContentExists("named-ident", "InvalidOperationException");
    });
    ...
    it("#region pragma", function () {
      testSupport.AssertContentExists("pragma", "#region verify that casts are properly colored");
    });
    ...
    it("single line comment", function () {
      testSupport.AssertContentExists("comment", "//neither foo below should be a named ident");
    });
    ...
    it("verbatim string with escaped quote", function () {
      testSupport.AssertContentExists("string", '@"this is ""another""\nmulti line\nstring"');
    });
    it("char", function () {
    ...
    it("xml doc comment content between tags", function () {
      testSupport.AssertContentExists("xmlDocCommentContent", "generic parameters");
    });
    it("xml doc comment content", function () {
      testSupport.AssertContentExists("xmlDocCommentContent", " Tests the coloring of generic method definitions and");
    });
  });
