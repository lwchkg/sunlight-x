...
describe("Diff tests", function () {
  ...
  it("= merge header", function () {
    testSupport.AssertContentExists("mergeHeader", "===================================================================");
  });
  it("--- header", function () {
    testSupport.AssertContentExists("header", "--- /path/to/original ''timestamp''");
  });
  it("+++ header", function () {
    testSupport.AssertContentExists("header", "+++ /path/to/new      ''timestamp''");
  });
  it("*** header", function () {
  ...
  it("no new line declaration", function () {
    testSupport.AssertContentExists("noNewLine", "\\ No newline at end of file");
  });
});