...
import { BeforeTokenizeEvent, AfterTokenizeEvent } from "./events";
import { Token } from "./token";
import { parseNextToken } from "./parse-next-token";
...
import type { ContextItemsType, EmbeddedLanguageDefinition, Language } from "./languages";
...
export class ParserContext {
  ...
  constructor(highlighter: Highlighter, unhighlightedCode: string, language: Language, userDefinedNameStore: UserDefinedNameStore, partialContext: AnalyzerContext | null | undefined, options: SunlightOptionsType) {
 ...
 */
export function Tokenize(highlighter: Highlighter, unhighlightedCode: string, language: Language, userDefinedNameStore: UserDefinedNameStore, partialContext: AnalyzerContext | null | undefined, options: SunlightOptionsType): ParserContext {
