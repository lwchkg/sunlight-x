...
export const customTokens = {
  function: {
    // php -r "$f = get_defined_functions(); $f = $f['internal']; arsort($f); echo '\"' . implode($f, '\", \"') . '\"';"
    values: [
  ...
  constant: {
    values: [
      ...
      // php -r "$c = array_keys(get_defined_constants()); arsort($c); echo '\"' . implode($c, '\", \"') . '\"';"
      "ZEND_THREAD_SAFE",
      "ZEND_DEBUG_BUILD",
      "XSL_CLONE_NEVER",
      "XSL_CLONE_AUTO",
...
export const namedIdentRules = {
  ...
  follows: [
    ...
    [
      { token: "keyword", values: ["class", "interface", "abstract", "final"] },
      util.whitespace
    ]
  ],
